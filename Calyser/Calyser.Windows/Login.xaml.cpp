...
void Calyser::Login::login_click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
	...
	//m_CommLayer->ReadDB();
	//
    int result = m_CommLayer->CheckLogin(email->Text->ToString(), password->Password->ToString());
	//
}


void Calyser::Login::cancel_click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
